...
void writeToEEPROM() {
  ...
  addr = addr + EEPROM_writeAnything(addr, cool_level_set);
  addr = addr + EEPROM_writeAnything(addr, warm_level_set);
...
bool readFromEEPROM() {
  ...
  addr = addr + EEPROM_readAnything(addr, cool_level_set);
  Serial.print(addr); Serial.print("\t");  Serial.println(cool_level_set);
  addr = addr + EEPROM_readAnything(addr, warm_level_set);
  Serial.print(addr); Serial.print("\t");  Serial.println(warm_level_set);

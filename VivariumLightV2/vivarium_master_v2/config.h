...
unsigned int n_lights = 3;
unsigned int slow_interval = 20;
unsigned int warm_level_cur[] = {0, 0, 0};
unsigned int cool_level_cur[] = {0, 0, 0};
unsigned int warm_level_set[] = {400, 200, 200};  // These are used as max values when in solar mode
unsigned int cool_level_set[] = {950, 650, 650}; // These are used as max values when in solar mode
unsigned int warm_level_cur_solar[] = {0, 0, 0}; // Current calculated solar values -- these are set in setSolarValues()
unsigned int cool_level_cur_solar[] = {0, 0, 0}; // Current calculated solar values -- these are set in setSolarValues()
